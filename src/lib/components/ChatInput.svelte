...
<div class="w-full flex justify-center">
  <div class="flex w-5/6 max-w-6xl">
    <div class="flex justify-centermin-h-[4rem] w-full bg-gray-600 rounded-l-xl">
      <textarea
      rows="1"
      bind:value={text}
      on:input={handleTextAreaSize}
      placeholder="Type your message"
      class="no-border w-full items-center my-auto resize-none m-4 text-2xl bg-gray-600 text-white"
      />
    </div>
