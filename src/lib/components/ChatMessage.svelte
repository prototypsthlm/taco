...
<div in:fade={{ duration: 400 }} class="p-4 md:p-8 flex justify-center">
...
<div
  ...
  class="p-4 md:p-8 bg-accent bg-opacity-10 flex justify-center"
>
  <div class="max-w-screen-md w-full flex gap-4 md:gap-8">
    <div
    ...
    {#if message?.answer}
      ...
      <div
        in:fade
        class="text-accent prose prose-invert overflow-x-hidden prose-pre:overflow-x-scroll"
      >
